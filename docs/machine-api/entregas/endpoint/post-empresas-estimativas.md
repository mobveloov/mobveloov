...
# Estimar entrega por empresa

> Permite obter a estimativa do valor da entrega por empresa em uma única categoria



## OpenAPI

````yaml pages/v2/openapi-entregas.json POST /entregas/empresas/{id}/estimativas
openapi: 3.1.0
info:
...
security:
  - basicAuth: []
    ApiKeyAuth: []
paths:
  /entregas/empresas/{id}/estimativas:
    post:
      summary: Estimar entrega por empresa
      description: >-
        Permite obter a estimativa do valor da entrega por empresa em uma única
        categoria
      parameters:
        - name: id
          in: path
