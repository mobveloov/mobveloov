...
> Permite obter a estimativa do valor da entrega em uma única categoria



## OpenAPI

````yaml pages/v2/openapi-entregas.json POST /entregas/estimativas
openapi: 3.1.0
info:
...
paths:
  /entregas/estimativas:
    post:
      summary: Estimar entrega
      description: Permite obter a estimativa do valor da entrega em uma única categoria
      requestBody:
        required: true
        content:
          application/json:
