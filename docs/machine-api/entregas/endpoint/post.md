...
> Ao acionar, abre uma nova solicitação de entrega padrão.



## OpenAPI

````yaml pages/v2/openapi-entregas.json POST /entregas
openapi: 3.1.0
info:
...
paths:
  /entregas:
    post:
      summary: Abrir entrega
      description: Ao acionar, abre uma nova solicitação de entrega padrão.
      requestBody:
        required: true
        content:
          application/json:
              ...
              properties:
                ...
                exigir_codigo_confirmacao:
                  ...
                  description: >-
                    ...
                    sem ele, resta cancelar a entrega.
      responses:
        '200':
          description: Sucesso
          content:
