...
# Enviar mensagem no chat central de condutor

> Envia uma mensagem no chat central dos condutores da bandeira.



## OpenAPI

````yaml pages/v2/openapi-corridas.json POST /mensagens/condutor/broadcast
openapi: 3.1.0
info:
...
security:
  - basicAuth: []
    ApiKeyAuth: []
paths:
  /mensagens/condutor/broadcast:
    post:
      summary: Enviar mensagem no chat central de condutor
      description: Envia uma mensagem no chat central dos condutores da bandeira.
      requestBody:
        required: true
        content:
          application/json:
