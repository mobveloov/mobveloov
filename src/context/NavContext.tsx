...
type AdminScreen = 'dashboard' | 'locations' | 'integration' | 'pricing' | 'dispatch' | 'drivers' | 'rides' | 'whatsapp' | 'manual' | 'settings' | 'users' | 'notifications' | 'audit' | 'reports' | 'finance' | 'subscription';
