    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-10">
      <div className="w-full max-w-[420px] rounded-2xl border border-slate-800 bg-slate-900/80 p-8 shadow-2xl shadow-black/40 sm:p-10">
        <div className="flex flex-col items-center text-center">
          ...
          <h1 className="text-2xl font-extrabold text-white">SuperAdmin</h1>
          <p className="mt-2 text-sm text-slate-400">Controle master da plataforma Veloov</p>
        </div>
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-xs text-slate-500">
          ...
          <span>Acesso exclusivo do dono da plataforma</span>
        </div>
